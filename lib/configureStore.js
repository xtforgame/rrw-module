...
exports.default = function (staticReducers) {
  ...
  store = (0, _redux.createStore)((0, _createReducer2.default)(staticReducers), initialState, compose(_redux.applyMiddleware.apply(undefined, middlewares.concat((0, _toConsumableArray3.default)(customMiddlewares)))));
